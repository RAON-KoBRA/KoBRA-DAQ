...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_open( cvt_V1190_data* p_data, UINT16 base_address, long vme_handle, CVT_V1X90_TYPES type)
{
	...
	p_data->m_common_data.set_MCST_CBLT= ( BUUL (*)( void*, UINT8, MCST_CBLT_board_pos))cvt_V1190_set_MCST_CBLT;
	p_data->m_type= type;

#ifdef CVT_V1190_USE_DATA_QUEUE
	p_data->m_queue= static_cast<UINT32*>(malloc( CVT_V1190_QUEUE_SIZE_DWORD* sizeof( UINT32)));	
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_close( cvt_V1190_data* p_data)
{
#ifdef CVT_V1190_USE_DATA_QUEUE
	if( p_data->m_queue!= NULL)
	{
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_write_2_micro( cvt_V1190_data* p_data, UINT16 ope_code, const UINT16* p_params, int num_params)
{
	UINT16 micro_hnd= 0;
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_read_from_micro( cvt_V1190_data* p_data, UINT16 ope_code, UINT16* p_params, int num_params)
{
	UINT16 micro_hnd= 0;
	// wait for micro register write ok
	do
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_bitmask_control( cvt_V1190_data* p_data, CVT_V1190_CONTROL_MSK value)
{
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_clear_bitmask_control( cvt_V1190_data* p_data, CVT_V1190_CONTROL_MSK value)
{
	UINT16 reg_value= value;
	// set bitmask to register
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_windows_width( cvt_V1190_data* p_data, UINT16 value)
{
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_windows_offset( cvt_V1190_data* p_data, UINT16 value)
{
	UINT16 reg_value= (UINT16)value;
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_get_channel_enable( cvt_V1190_data* p_data, UINT16 *p_enable_msk)
{
	int num_ch= 0;
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_trigger_match( cvt_V1190_data* p_data)
{
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_head_trail_enable( cvt_V1190_data* p_data)
{
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_head_trail_disable( cvt_V1190_data* p_data)
{
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_read_MEB( cvt_V1190_data* p_data, void* p_buff, UINT32* p_buff_size)
{
	BUUL is_berr= FALSE;
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_continuous_acquisition_mode( cvt_V1190_data* p_data, CVT_V1190_EDGE_DETECTION_ENUM edge_detection, CVT_V1190_PAIR_RES_WIDTH_ENUM res_width, const UINT16 *p_enable_msk)
{
	UINT16 reg_value;
	//
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_trigger_matching_acquisition_mode( cvt_V1190_data* p_data, INT16 window_width, INT16 window_offset, INT16 extra_search_margin, INT16 reject_margin, CVT_V1190_EDGE_DETECTION_ENUM edge_detection, CVT_V1190_PAIR_RES_WIDTH_ENUM res_width, const UINT16 *p_enable_msk, BUUL header_trailer_enable, BUUL empty_event_enable, BUUL trigger_time_tag_enable)
{
	UINT16 reg_value;
	UINT16 set_msk= 0;
	UINT16 clear_msk= 0;
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_interrupt( cvt_V1190_data* p_data, UINT8 level, UINT8 vector)
{
	UINT16 reg_value;
	//
	// interrupt level
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_readout_mode( cvt_V1190_data* p_data, BUUL bus_error_enable, BUUL align64_enable, UINT8 blt_event_number)
{
	UINT16 reg_value;
	UINT16 set_msk= 0;
	UINT16 clear_msk= 0;
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_get_status( cvt_V1190_data* p_data, BUUL *p_is_data_ready, BUUL *p_is_term_on, BUUL *p_is_buffer_full, BUUL *p_is_buffer_almost_full, CVT_V1190_STATUS_RES* p_resolution, UINT8* p_error_bitmask)
{
	UINT16 reg_value= 0;
	//
	...
	*p_resolution= static_cast<CVT_V1190_STATUS_RES>(CVT_V1190_GET_STATUS_RES( reg_value));
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_get_event_counter( cvt_V1190_data* p_data, UINT32* p_counter)
{
	UINT32 reg_value;
	*p_counter= 0;
	// Event Counter
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_get_event_stored( cvt_V1190_data* p_data, UINT16* p_counter)
{
	UINT16 reg_value;
	*p_counter= 0;
	// Event stored
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_get_system_info( cvt_V1190_data* p_data, UINT16 *p_firmware_rev, UINT32 *p_tdc_id_buff, UINT16 *p_micro_firmware_rev, UINT16 *p_serial_number)
{
	UINT16 reg_value= 0;
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_data_clear( cvt_V1190_data* p_data)
{
	UINT16 reg_value= 0;
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_module_reset( cvt_V1190_data* p_data)
{
	UINT16 reg_value= 0;
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_channel_enable( cvt_V1190_data* p_data, const UINT16* p_enable_msk)
{
	int num_ch= 0;
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_almost_full( cvt_V1190_data* p_data, UINT16 almost_full_value)
{
	UINT16 reg_value= 0;
	//
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_peek_event( cvt_V1190_data *p_data, UINT32 *out_buff, long *p_out_buff_size, UINT32 *p_event_count)
{
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_inqueue( cvt_V1190_data* p_data, const UINT32* in_buff, UINT32 in_buff_size)
{
	if( !in_buff_size)
		return TRUE;
...
// 
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_dequeue( cvt_V1190_data* p_data, UINT32 *out_buff, UINT32 out_buff_size)
{
	if( !out_buff_size)
		return TRUE;
...
//
////////////////////////////////////////////////////////////////////////////////////////////////
BUUL cvt_V1190_set_MCST_CBLT( cvt_V1190_data* p_data, UINT8 address, MCST_CBLT_board_pos pos)
{
	UINT16 reg_value;
	//
	// MCST/CBLT address
