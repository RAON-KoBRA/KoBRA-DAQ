...
extern uint32_t clock_number_lower;
extern uint32_t clock_number_upper;
...
uint32_t clock_number_lower_tmp;
...
*/
	...
	//==================================mcst reg for MCST board first                                        
        addr_ary=(SILICON_ARY_ADDR<<16)|0x101A;
        mcst_reg_order = 0x02;
			...
			case CVT_QTP_DATUM:
					{
						...
						*pdata++=measure;
						//tmp_channel = channel;
						//printf("(S3 ADC) measurement; uv:%d, ov:%d, channel:%d, measurement:%d, \n", UV, OV, channel, measure);
